                ...
                <div class="card-body">
                    <form>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="discount" id="discount" value="{{ $product->discount }}" min="0">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="stock" id="stock" value="{{ $product->stock }}" min="0" required>
                        ...
                        <fieldset class="form-group row">
                            ...
                            <div class="col-sm-8">
                                ...
                                <div class="form-check form-check-inline">
                                    <input type="checkbox" class="form-check-input" name="categories[]" id="category{{ $index }}" value="{{ $category->id }}" @if(in_array($category->id, $product->category_ids)) checked @endif>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10 offset-sm-1">
                                <textarea class="form-control" name="description" id="description" rows="3">{{ $product->detail }}</textarea>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10 offset-sm-1" id="upload_img">
                                ...
                                <div class="img-content m-1">
                                    <img src="{{ asset($image->url) }}" class="img-thumbnail" data-name="{{ $image->name }}">
                                    <i class="fa fa-times-circle upload-remove-icon"></i>
                                </div>
                                @endforeach
                            </div>
                        </div>
...
@section('javascript')
    <script type="text/javascript">
        ...
        let images = JSON.parse('@json($product->images)');
        ...
        $('form').on('submit', function() {
            ...
            $.ajax({
                url: "{{ route('admin.edit_product', $product->id) }}",
                method: 'post',
                data: formData,
                cache: false,
                contentType: false,
                ...
                success: function (result) {
                    if (result.status == 'success') {
                        alertModal.getElementsByClassName('card-text')[0].innerText = '修改成功。';
                        $(alertModal).modal('show');
