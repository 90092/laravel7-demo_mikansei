                ...
                <div class="col-xl-10 col-lg-12 col-md-9">
                    <div class="card o-hidden border-0 shadow-lg my-5">
                        <div class="card-body p-0">
                            <div class="row">
                                <div class="col-lg-6 d-none d-lg-block bg-gradient-dark" style="position: relative;">
                                    <i class="fa fa-image login-image text-white"></i>
                                </div>
                                <div class="col-lg-6">
                                    <div class="p-5">
            ...
            function login() {
                ...
                $.ajax({
                    ...
                    success: function (result) {
                        location.href = '{{ session("after_login", route("admin.index")) }}';
                    },
